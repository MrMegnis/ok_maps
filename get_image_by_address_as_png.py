...
def get_image_by_address_as_png(addres, zoom, layer, path, api_key="40d1649f-0493-4b70-98ba-98533de7710b"):
    ...
    return get_image_by_cords_as_png(cords, zoom, layer, path, api_key)
